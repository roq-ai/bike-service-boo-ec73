...
export function useServiceManagerFindMany<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useServiceManagerFindMany', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.service_manager.findMany(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useServiceManagerCount<T extends Prisma.service_managerCountArgs, R extends number>(
  args?: Prisma.SelectSubset<T, Prisma.service_managerCountArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useServiceManagerCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.service_manager.count(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useServiceManagerFindManyWithCount<
  T extends Prisma.service_managerFindManyArgs,
  R extends { data: GetFindResult<Prisma.$service_managerPayload<DefaultArgs>, T>[]; count: number },
>(
  args?: Prisma.SelectSubset<T, Prisma.service_managerFindManyArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useServiceManagerFindManyWithCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.service_manager.findManyWithCount(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useServiceManagerFindFirst<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useServiceManagerFindFirst', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.service_manager.findFirst(args, options);
      return result as R;
    },
    {
      ...swrOptions,
