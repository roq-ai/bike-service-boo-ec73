  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience the best two-wheeler service with Bike Service Booking Online. Enjoy comfort at your home, delivered by our expert mechanics."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1693726724670-465b844c0343?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHx0d28td2hlZWxlcnxlbnwwfHx8fDE2OTgzOTUxNzd8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@photoloni?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Pasqualino Capobianco`}</Link>{' '}
              on{' '}
              <Link
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience the best two-wheeler service with Bike Service Booking Online. Enjoy comfort at your home, delivered by our expert mechanics.`}
            </Text>
            <Box
